...
//*
  ...
  eleUnfBiasErri[1 ] = 0.6140 ;
  eleUnfBiasErri[2 ] = 0.4674 ;
  eleUnfBiasErri[3 ] = 0.1731 ;
  eleUnfBiasErri[4 ] = 0.2422 ;
  eleUnfBiasErri[5 ] = 0.6674 ;
  eleUnfBiasErri[6 ] = 1.1242 ;
  eleUnfBiasErri[7 ] = 1.5570 ;
  eleUnfBiasErri[8 ] = 1.9686 ;
  eleUnfBiasErri[9 ] = 2.2997 ;
  eleUnfBiasErri[10] = 2.5327 ;
  eleUnfBiasErri[11] = 2.6933 ;
  eleUnfBiasErri[12] = 2.7797 ;
  eleUnfBiasErri[13] = 2.8235 ;
