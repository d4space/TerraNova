...
int combineTheory(const TString BaseName)
{
  ...
  Double_t FEWZ_Wp[nBins-1];
  Double_t FEWZ_Wp_up[nBins-1];
  Double_t FEWZ_Wp_down[nBins-1];
  Double_t FEWZ_Wm[nBins-1];
  Double_t FEWZ_Wm_up[nBins-1];
  Double_t FEWZ_Wm_down[nBins-1];
  Double_t FEWZ_Wincl[nBins-1];
  Double_t FEWZ_Wincl_up[nBins-1];
  Double_t FEWZ_Wincl_down[nBins-1];
