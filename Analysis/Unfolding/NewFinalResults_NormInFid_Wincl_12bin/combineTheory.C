...
int combineTheory(const TString BaseName)
{
  ...
  TH1D *lFewz_1_12Bin   = new TH1D("","",nBins-1,Wpt12Bins);
  TH1D *lFewz_2_12Bin   = new TH1D("","",nBins-1,Wpt12Bins);

  //FEWZ Errors
  TH1D* Scale1 = (TH1D*)f_Fewz_1->Get("Norm_ScaleErr")->Clone("Scale1");
  TH1D* PDF1   = (TH1D*)f_Fewz_1->Get("Norm_PDFErr")->Clone("PDF1");
  ...
  TH1D* hxsec = new TH1D("hxsec","hxsec",12,0,12);
