...
//*
  ...
  muUnfBiasErri[1 ] = 0.9277 ;
  muUnfBiasErri[2 ] = 1.7211 ;
  muUnfBiasErri[3 ] = 1.1504 ;
  muUnfBiasErri[4 ] = 0.3039 ;
  muUnfBiasErri[5 ] = 0.6472 ;
  muUnfBiasErri[6 ] = 0.2676 ;
  muUnfBiasErri[7 ] = 0.4361 ;
  muUnfBiasErri[8 ] = 0.7751 ;
  muUnfBiasErri[9 ] = 1.9656 ;
  muUnfBiasErri[10] = 4.3227 ;
  muUnfBiasErri[11] = 3.0739 ;
  muUnfBiasErri[12] = 5.4563 ;
  muUnfBiasErri[13] = 4.9397 ;
