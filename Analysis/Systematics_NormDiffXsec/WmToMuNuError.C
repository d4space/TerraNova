...
//  Print out result
  ...
  TFile f_out(resultDir+"/WmToMuNuErrors.root","recreate");
  ...
  ///Write all errors to root
    ...
    double PowhegPDFm[13];
    PowhegPDFm[0] = 0; 
    PowhegPDFm[1] =0.805695;    //3.1886;// 4.4  ; 
    PowhegPDFm[2] =0.193853;    //3.9034;// 4.385; 
    PowhegPDFm[3] =0.529425;    //4.3073;// 4.426;
    PowhegPDFm[4] =0.705878;    //4.4302;// 4.444;
    PowhegPDFm[5] =0.697846;    //4.6290;// 4.451;
    PowhegPDFm[6] =0.707969;    //4.6619;// 4.532;
    PowhegPDFm[7] =0.529504;    //7.7632;// 7.792;
    PowhegPDFm[8] =0.780084;    //6.2674;// 6.181;
    PowhegPDFm[9] =1.43238 ;    //4.9092;// 4.622;
    PowhegPDFm[10]=2.21681 ;    //4.7558;// 4.33 ;
    PowhegPDFm[11]=3.18584 ;    //4.9631;// 4.573;
    PowhegPDFm[12]=3.50682 ;    //5.3300;// 5.005;
    //PowhegPDFm[13]=    //5.6229;// 5.269;
    
    for(int i(1);i<13;i++)
    {
      h_PowhegPDF->SetBinContent(i,PowhegPDFm[i]);
    }

    for(int i(1);i<14;i++)
    {
      h_tracksig->SetBinContent(i,mutracksigm[i]);
   
      h_trackbck->SetBinContent(i,mutrackbckm[i]);
      
      h_idisosig->SetBinContent(i,muidisosigm[i]);
   
      h_idisobck->SetBinContent(i,muidisobckm[i]);
   
      h_track->SetBinContent(i,mutrackm[i]);
   
      h_idiso->SetBinContent(i,muidisom[i]);
   
      h_toy->SetBinContent(i,mutoym[i]);
   
      h_POG->SetBinContent(i,muPOGm[i]);
   
      h_TotalEff->SetBinContent(i,mutotaleffm[i]);
   
      h_Stat->SetBinContent(i,mustatm[i]);
   
      h_met->SetBinContent(i,mumetm[i]);
   
      h_scale->SetBinContent(i,muscalem[i]);
   
      h_smear->SetBinContent(i,musmearm[i]);
   
      h_EnMomRes->SetBinContent(i,muMomResm[i]);
   
      h_qcdbckgr->SetBinContent(i,muqcdbckgrm[i]);
   
      h_qcdshape->SetBinContent(i,muqcdshapem[i]);
   
      h_ewk->SetBinContent(i,muewkm[i]);
   
      h_fsr->SetBinContent(i,mufsrm[i]);
   
      h_SvdUnf->SetBinContent(i,musvdunfm[i]);
   
      h_UnfoldBias->SetBinContent(i,muBiasm[i]);
   
      h_TotalSyst->SetBinContent(i,systtotalm[i]);
   
      h_TotalUncer->SetBinContent(i,totaluncerm[i]);
