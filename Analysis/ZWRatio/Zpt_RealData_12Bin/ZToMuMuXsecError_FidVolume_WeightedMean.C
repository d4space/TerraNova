...
#include "./Utils/const.h"
 ...
 /////Zpt NormDiffXsec after FSR corr
 double ZptNormDiffXsec[19]={0};
	ZptNormDiffXsec[1] =0.03338098 ;   //1	   0.0-2.5    
	ZptNormDiffXsec[2] =0.05532895 ;   //2	   2.5-5.0    
	ZptNormDiffXsec[3] =0.05192021 ;   //3	   5.0-7.5    
	ZptNormDiffXsec[4] =0.03861802 ;   //4	   7.5-10.0   
	ZptNormDiffXsec[5] =0.03550062 ;   //5	   10.0-12.5  
	ZptNormDiffXsec[6] =0.02409441 ;   //6	   12.5-15.0  
	ZptNormDiffXsec[7] =0.02251570 ;   //7	   15.0-17.5  
	ZptNormDiffXsec[8] =0.01715371 ;   //8	   17.5-20.0  
	ZptNormDiffXsec[9] =0.01175338 ;   //9	   20.0-30.0  
	ZptNormDiffXsec[10]=0.00650825 ;  //10    30.0-40.0  
	ZptNormDiffXsec[11]=0.00402494 ;  //11    40.0-50.0  
	ZptNormDiffXsec[12]=0.00215579 ;  //12    50.0-70.0  
	ZptNormDiffXsec[13]=0.00088889 ;  //13    70.0-90.0  
	ZptNormDiffXsec[14]=0.00040997 ;  //14    90.0-110.0 
	ZptNormDiffXsec[15]=0.00016520 ;  //15    110.0-150.0
	ZptNormDiffXsec[16]=0.00007652 ;  //16    150.0-190.0
	ZptNormDiffXsec[17]=0.00000898 ;  //17    190.0-250.0
	ZptNormDiffXsec[18]=0.00000444 ;  //18    250.0-600.0
  ...
  double ZptSystBkg_plus[19]={0};
	...
	for(int i(1);i<nBinsZpt;i++)
	{
	  ...
	  cout<<"18 bin ZptSystBkg_plus[i] in %\t"<<i<<"\t"<<ZptSystBkg_plus[i]<<endl;
	}
  ...
  double ZptSystBkg_plus12[13]={0};
    ...
    ZptSystBkg_plus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptSystBkg_plus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptSystBkg_plus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptSystBkg_plus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5

    cout <<"Weighted mean of ZptSystBkg_plus 1,2,3 \t"<<ZptSystBkg_plus12[1]<<endl;
     //ZptSystBkg_plus12[2] =TMath::Max(ZptSystBkg_plus[4],ZptSystBkg_plus[5]);               	      // 7.5-12.5   
     ZptSystBkg_plus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptSystBkg_plus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptSystBkg_plus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     //ZptSystBkg_plus12[3] =TMath::Max(ZptSystBkg_plus[6],ZptSystBkg_plus[7]);                        // 12.5-17.5  
     ZptSystBkg_plus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptSystBkg_plus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptSystBkg_plus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     //ZptSystBkg_plus12[4] =TMath::Max(ZptSystBkg_plus[8],ZptSystBkg_plus[9]);                        // 17.5-30.0  
     ZptSystBkg_plus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptSystBkg_plus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptSystBkg_plus[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
    cout <<"Weighted mean of ZptSystBkg_plus 8,9 \t"<<ZptSystBkg_plus12[4]<<endl;
    cout <<"ZptSystBkg_plus 8,9 \t"<<ZptSystBkg_plus[8]<<"\t"<<ZptSystBkg_plus[9]<<"\t"<<
      hZptBins_LinScale->GetXaxis()->GetBinWidth(8)<<"\t"<<
      hZptBins_LinScale->GetXaxis()->GetBinWidth(9)<<"\t"<<
      ZptNormDiffXsec[8]<<"\t"<<
      ZptNormDiffXsec[9]<<"\t"<<
      endl;
     ...
     ZptSystBkg_plus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptSystBkg_plus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptSystBkg_plus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptSystBkg_plus 13,14 \t"<<ZptSystBkg_plus12[8]<<endl;
  ...
  double ZptSystBkg_minus12[13]={0};
    ...
    ZptSystBkg_minus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptSystBkg_minus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptSystBkg_minus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptSystBkg_minus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptSystBkg_minus 1,2,3 \t"<<ZptSystBkg_minus12[1]<<endl;
     ZptSystBkg_minus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptSystBkg_minus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptSystBkg_minus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptSystBkg_minus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptSystBkg_minus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptSystBkg_minus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptSystBkg_minus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptSystBkg_minus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptSystBkg_minus[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptSystBkg_minus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptSystBkg_minus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptSystBkg_minus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptSystBkg_minus 13,14 \t"<<ZptSystBkg_minus12[8]<<endl;
  ...
  double ZptSystEff_plus12[13]={0};
    ...
    ZptSystEff_plus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptSystEff_plus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptSystEff_plus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptSystEff_plus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptSystEff_plus 1,2,3 \t"<<ZptSystEff_plus12[1]<<endl;
     ZptSystEff_plus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptSystEff_plus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptSystEff_plus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptSystEff_plus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptSystEff_plus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptSystEff_plus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptSystEff_plus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptSystEff_plus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptSystEff_plus[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptSystEff_plus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptSystEff_plus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptSystEff_plus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptSystEff_plus 13,14 \t"<<ZptSystEff_plus12[8]<<endl;
  ...
  double ZptSystEff_minus12[13]={0};
    ...
    ZptSystEff_minus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptSystEff_minus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptSystEff_minus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptSystEff_minus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptSystEff_minus 1,2,3 \t"<<ZptSystEff_minus12[1]<<endl;
     ZptSystEff_minus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptSystEff_minus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptSystEff_minus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptSystEff_minus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptSystEff_minus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptSystEff_minus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptSystEff_minus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptSystEff_minus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptSystEff_minus[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptSystEff_minus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptSystEff_minus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptSystEff_minus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptSystEff_minus 13,14 \t"<<ZptSystEff_minus12[8]<<endl;
  ...
  double ZptSystFSRErr12[13]={0};
    ...
    ZptSystFSRErr12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptSystFSRErr[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptSystFSRErr[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptSystFSRErr[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptSystFSRErr 1,2,3 \t"<<ZptSystFSRErr12[1]<<endl;
     ZptSystFSRErr12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptSystFSRErr[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptSystFSRErr[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptSystFSRErr12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptSystFSRErr[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptSystFSRErr[7])*ZptNormDiffXsec[7]
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptSystFSRErr12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptSystFSRErr[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptSystFSRErr[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptSystFSRErr12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptSystFSRErr[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptSystFSRErr[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptSystFSRErr 13,14 \t"<<ZptSystFSRErr12[8]<<endl;
  ...
  double ZptUnfoldSyst_doubleGaussin_plus12[13]={0};
    ...
    ZptUnfoldSyst_doubleGaussin_plus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptUnfoldSyst_doubleGaussin_plus[1]*ZptNormDiffXsec[1] 
			  		 + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptUnfoldSyst_doubleGaussin_plus[2]*ZptNormDiffXsec[2]
			  		 + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptUnfoldSyst_doubleGaussin_plus[3]*ZptNormDiffXsec[3])
      			  	 /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			  	    + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			  	    + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptUnfoldSyst_doubleGaussin_plus 1,2,3 \t"<<ZptUnfoldSyst_doubleGaussin_plus12[1]<<endl;
     ZptUnfoldSyst_doubleGaussin_plus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptUnfoldSyst_doubleGaussin_plus[4]*ZptNormDiffXsec[4]
	 		    		+hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptUnfoldSyst_doubleGaussin_plus[5]*ZptNormDiffXsec[5])
       			   		/(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     		+hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptUnfoldSyst_doubleGaussin_plus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptUnfoldSyst_doubleGaussin_plus[6]*ZptNormDiffXsec[6]
	 		   		 +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptUnfoldSyst_doubleGaussin_plus[7]*ZptNormDiffXsec[7])
       			   		/(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			   		  +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptUnfoldSyst_doubleGaussin_plus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptUnfoldSyst_doubleGaussin_plus[8]*ZptNormDiffXsec[8]
	 		    		+hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptUnfoldSyst_doubleGaussin_plus[9]*ZptNormDiffXsec[9])
       			   		/(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     		+hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptUnfoldSyst_doubleGaussin_plus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptUnfoldSyst_doubleGaussin_plus[13]*ZptNormDiffXsec[13]
	 		   		 +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptUnfoldSyst_doubleGaussin_plus[14]*ZptNormDiffXsec[14])
       			   		/(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			   		  +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptUnfoldSyst_doubleGaussin_plus 13,14 \t"<<ZptUnfoldSyst_doubleGaussin_plus12[8]<<endl;
  ...
  double ZptUnfoldSyst_doubleGaussin_minus12[13]={0};
    ...
    ZptUnfoldSyst_doubleGaussin_minus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptUnfoldSyst_doubleGaussin_minus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptUnfoldSyst_doubleGaussin_minus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptUnfoldSyst_doubleGaussin_minus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptUnfoldSyst_doubleGaussin_minus 1,2,3 \t"<<ZptUnfoldSyst_doubleGaussin_minus12[1]<<endl;
     ZptUnfoldSyst_doubleGaussin_minus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptUnfoldSyst_doubleGaussin_minus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptUnfoldSyst_doubleGaussin_minus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptUnfoldSyst_doubleGaussin_minus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptUnfoldSyst_doubleGaussin_minus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptUnfoldSyst_doubleGaussin_minus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptUnfoldSyst_doubleGaussin_minus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptUnfoldSyst_doubleGaussin_minus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptUnfoldSyst_doubleGaussin_minus[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptUnfoldSyst_doubleGaussin_minus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptUnfoldSyst_doubleGaussin_minus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptUnfoldSyst_doubleGaussin_minus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptUnfoldSyst_doubleGaussin_minus 13,14 \t"<<ZptUnfoldSyst_doubleGaussin_minus12[8]<<endl;
  ...
  double ZptUnfoldingShapeSyst_plus12[13]={0};
    ...
    ZptUnfoldingShapeSyst_plus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptUnfoldingShapeSyst_plus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptUnfoldingShapeSyst_plus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptUnfoldingShapeSyst_plus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptUnfoldingShapeSyst_plus 1,2,3 \t"<<ZptUnfoldingShapeSyst_plus12[1]<<endl;
     ZptUnfoldingShapeSyst_plus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptUnfoldingShapeSyst_plus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptUnfoldingShapeSyst_plus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptUnfoldingShapeSyst_plus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptUnfoldingShapeSyst_plus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptUnfoldingShapeSyst_plus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptUnfoldingShapeSyst_plus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptUnfoldingShapeSyst_plus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptUnfoldingShapeSyst_plus[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptUnfoldingShapeSyst_plus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptUnfoldingShapeSyst_plus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptUnfoldingShapeSyst_plus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptUnfoldingShapeSyst_plus 13,14 \t"<<ZptUnfoldingShapeSyst_plus12[8]<<endl;
  ...
  double ZptUnfoldingShapeSyst_minus12[13]={0};
    ...
    ZptUnfoldingShapeSyst_minus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptUnfoldingShapeSyst_minus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptUnfoldingShapeSyst_minus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptUnfoldingShapeSyst_minus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptUnfoldingShapeSyst_minus 1,2,3 \t"<<ZptUnfoldingShapeSyst_minus12[1]<<endl;
     ZptUnfoldingShapeSyst_minus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptUnfoldingShapeSyst_minus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptUnfoldingShapeSyst_minus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptUnfoldingShapeSyst_minus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptUnfoldingShapeSyst_minus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptUnfoldingShapeSyst_minus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptUnfoldingShapeSyst_minus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptUnfoldingShapeSyst_minus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptUnfoldingShapeSyst_minus[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptUnfoldingShapeSyst_minus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptUnfoldingShapeSyst_minus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptUnfoldingShapeSyst_minus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptUnfoldingShapeSyst_minus 13,14 \t"<<ZptUnfoldingShapeSyst_minus12[8]<<endl;
  ...
  double ZptAcceptSyst_plus12[13]={0};
    ...
    ZptAcceptSyst_plus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptAcceptSyst_plus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptAcceptSyst_plus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptAcceptSyst_plus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptAcceptSyst_plus 1,2,3 \t"<<ZptAcceptSyst_plus12[1]<<endl;
     ZptAcceptSyst_plus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptAcceptSyst_plus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptAcceptSyst_plus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptAcceptSyst_plus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptAcceptSyst_plus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptAcceptSyst_plus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptAcceptSyst_plus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptAcceptSyst_plus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptAcceptSyst_plus[9]*ZptNormDiffXsec[9])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptAcceptSyst_plus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptAcceptSyst_plus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptAcceptSyst_plus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptAcceptSyst_plus 13,14 \t"<<ZptAcceptSyst_plus12[8]<<endl;
  ...
  double ZptAcceptSyst_minus12[13]={0};
    ...
    ZptAcceptSyst_minus12[1]= ( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptAcceptSyst_minus[1]*ZptNormDiffXsec[1] 
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptAcceptSyst_minus[2]*ZptNormDiffXsec[2]
			   + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptAcceptSyst_minus[3]*ZptNormDiffXsec[3])
      			   /( hZptBins_LinScale->GetXaxis()->GetBinWidth(1)*ZptNormDiffXsec[1]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(2)*ZptNormDiffXsec[2]
			      + hZptBins_LinScale->GetXaxis()->GetBinWidth(3)*ZptNormDiffXsec[3]);			// 0.0-7.5
    cout <<"Weighted mean of ZptAcceptSyst_minus 1,2,3 \t"<<ZptAcceptSyst_minus12[1]<<endl;
     ZptAcceptSyst_minus12[2] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptAcceptSyst_minus[4]*ZptNormDiffXsec[4]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptAcceptSyst_minus[5]*ZptNormDiffXsec[5])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(4)*ZptNormDiffXsec[4]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(5)*ZptNormDiffXsec[5]);               	        
     ZptAcceptSyst_minus12[3] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptAcceptSyst_minus[6]*ZptNormDiffXsec[6]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptAcceptSyst_minus[7]*ZptNormDiffXsec[7])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(6)*ZptNormDiffXsec[6]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(7)*ZptNormDiffXsec[7]);               	         
     ZptAcceptSyst_minus12[4] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptAcceptSyst_minus[8]*ZptNormDiffXsec[8]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptAcceptSyst_minus[9])*ZptNormDiffXsec[9]
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(8)*ZptNormDiffXsec[8]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(9)*ZptNormDiffXsec[9]);               	         
     ...
     ZptAcceptSyst_minus12[8] =(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptAcceptSyst_minus[13]*ZptNormDiffXsec[13]
	 		    +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptAcceptSyst_minus[14]*ZptNormDiffXsec[14])
       			   /(hZptBins_LinScale->GetXaxis()->GetBinWidth(13)*ZptNormDiffXsec[13]
			     +hZptBins_LinScale->GetXaxis()->GetBinWidth(14)*ZptNormDiffXsec[14]);               	         
    cout <<"Weighted mean of ZptAcceptSyst_minus 13,14 \t"<<ZptAcceptSyst_minus12[8]<<endl;
    ...
    cout << "======= ZptSystBkg Put in note=======" << endl;
    cout << fixed << setprecision(4);
    for(int i(1);i<nBins12;i++)
    {
      cout<<
   ...
   cout << " \\"<<"\\" << endl;
    ...
    {
      cout<<
	" & "<<ZptSystBkg_minus12[i] ;
    }
   cout << " \\"<<"\\" << endl;
   cout << endl;
    cout << fixed << setprecision(8);
    
    cout << "======= ZptSystUnfShape Put in note=======" << endl;
    cout << fixed << setprecision(4);
    for(int i(1);i<nBins12;i++)
    {
      cout<<
	" & "<<ZptUnfoldingShapeSyst_plus12[i] ;
    }
   cout << " \\"<<"\\" << endl;
    for(int i(1);i<nBins12;i++)
    {
      cout<<
	" & "<<ZptUnfoldingShapeSyst_minus12[i] ;
    }
   cout << " \\"<<"\\" << endl;
   cout << endl;
    cout << fixed << setprecision(8);
    
    cout << "======= ZptUnfoldSyst_doubleGaussin Put in note=======" << endl;
    cout << fixed << setprecision(4);
    for(int i(1);i<nBins12;i++)
    {
      cout<<
	" & "<<ZptUnfoldSyst_doubleGaussin_plus12[i] ;
    }
   cout << " \\"<<"\\" << endl;
    for(int i(1);i<nBins12;i++)
    {
      cout<<
	" & "<<ZptUnfoldSyst_doubleGaussin_minus12[i] ;
    }
   cout << " \\"<<"\\" << endl;
   cout << endl;
    cout << fixed << setprecision(8);
    
    cout << "======= ZptSystEff Put in note=======" << endl;
    cout << fixed << setprecision(4);
    for(int i(1);i<nBins12;i++)
    {
      cout<<
   ...
   cout << " \\"<<"\\" << endl;
    ...
    {
      cout<<
	" & "<<ZptSystEff_minus12[i] ;
    }
   cout << " \\"<<"\\" << endl;
   cout << endl;
    cout << fixed << setprecision(8);

    cout << "======= ZptMadgraphSyst Put in note=======" << endl;
    cout << fixed << setprecision(4);
    for(int i(1);i<nBins12;i++)
    {
      cout<<
